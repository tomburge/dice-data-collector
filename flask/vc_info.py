...
def get_vm_info(vm, depth=1, max_depth=20):
    ...
    try:
        ...
        elif parent.parent.parent and type(parent.parent.parent) == vim.Datacenter and type(parent.parent.parent) is not None == vim.Datacenter:
            datacenter = parent.parent.parent.name
        elif parent.parent.parent.parent and type(parent.parent.parent.parent) == vim.Datacenter and type(parent.parent.parent.parent) is not None == vim.Datacenter:
            datacenter = parent.parent.parent.parent.name
        elif parent.parent.parent.parent.parent and type(parent.parent.parent.parent.parent) == vim.Datacenter and type(parent.parent.parent.parent.parent) is not None == vim.Datacenter:
            datacenter = parent.parent.parent.parent.parent.name
        elif parent.parent.parent.parent.parent.parent and type(parent.parent.parent.parent.parent.parent) == vim.Datacenter and type(parent.parent.parent.parent.parent.parent) is not None == vim.Datacenter:
            datacenter = parent.parent.parent.parent.parent.parent.name
        elif parent.parent.parent.parent.parent.parent.parent and type(parent.parent.parent.parent.parent.parent.parent) == vim.Datacenter and type(parent.parent.parent.parent.parent.parent.parent) is not None == vim.Datacenter:
            datacenter = parent.parent.parent.parent.parent.parent.parent.name
        elif parent.parent.parent.parent.parent.parent.parent.parent and type(parent.parent.parent.parent.parent.parent.parent.parent) == vim.Datacenter and type(parent.parent.parent.parent.parent.parent.parent.parent) is not None == vim.Datacenter:
